...
const TransactionItem = ({ item, onDeleteSuccess }) => {
  ...
  const deleteTransaction = async () => {
    console.log(`${API_LINKS.RECORDS}/${_id}`);
    await axios
      .delete(`${API_LINKS.RECORDS}/${_id}`)
      .then(() =>
        Platform.OS == "android"
          ? ToastAndroid.show(
              "Transaction deleted!",
      ...
      .catch(() => Alert.alert("Error!", "Cannot delete transaction")).finally(()=>{
        onDeleteSuccess();
      });
  };
  ...
  return (
    ...
    >
        ...
        <Image
          ...
          source={
            category === "food"
              ...
              ? require("../../assets/subscriptions.png")
              : category === "purchases"
              ? require("../../assets/purchases.png")
              : category === "bills"
              ? require("../../assets/bills.png")
              : category === "allowance"
              ? require("../../assets/allowance.png")
              : category === "comission"
              ...
              ? require("../../assets/investment.png")
              : category === "salary"
              ? require("../../assets/salary.png")
              : category === "selling"
              ? require("../../assets/selling.png")
      ...
      <View style={{ flex: 0.2, alignItems: "flex-end" }}>
        <Text
          style={{
            color: type === "income" ? Colors.NIGHT_GREEN : Colors.NIGHT_RED,
            fontSize: 18,
          }}
          numberOfLines={1}
          ellipsizeMode="tail"
