...
const ChartsView = () => {
  ...
  const fetchIncomeAndExpense = async () => {
    ...
    try {
      setLoading(true);
      await axios
        .get(`${API_LINKS.RECORDS}/user/${userId}/data`)
        .then((response) => {
      ...
      Alert.alert(
        "Error!",
        "Cannot load data! Please check your internet connection"
      );
      return false;
    } finally {
      setLoading(false);
  ...
  const fetchIncomeDetails = async () => {
    ...
    try {
      setLoading(true);
      await axios
        .get(`${API_LINKS.RECORDS}/user/${userId}/income`)
        .then((response) => {
  ...
  const fetchExpenseDetails = async () => {
    ...
    try {
      setLoading(true);
      await axios
        .get(`${API_LINKS.RECORDS}/user/${userId}/expense`)
        .then((response) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={{ color: Colors.DARK_GRAY, fontSize: 14 }}>
                Total Expense = Rs.{totalExpense * -1}
              </Text>
            </View>
          </View>
          <View
